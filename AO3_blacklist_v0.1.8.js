...
(function () {
  ...
  btnOpenSetting.innerHTML = 'AO3Blacklist';
  ...
  mainDivCover.innerHTML = `
    <div class="vpv-AO3-main-con">
      ...
      <h3 class="title">AO3Blacklist v0.1.8</h3>
      ...
      <div class="inner-cover-users">
        <div class="ban-users-list-con">
          ...
          <button class="btn-open-add-user">Add</button>
        ...
        <div class="import-export-con">
          ...
          <div class="import-left">
            ...
            <div class="export-items">
              <label>
                <input type="checkbox"> Blacklisted Authors
              </label>
            </div>
            <div class="export-items">
              <label>
